...
local function GetPlanet(planetUtilities, planetID)
	...
	local planetData = {
		...
		mapDisplay = {
			...
			image = image,
			size = planetUtilities.PLANET_SIZE_MAP*0.56,
			...
			aiConfig = {
				...
				},
				{
					...
					startUnits = {
						...
						{ name = 'euf_marine', x = 5000, z = 150, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {4400, 200}},		}, },
						{ name = 'euf_marine', x = 5000, z = 1950, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {4200, 1900}},	}, },						
						{ name = 'euf_marine', x = 5000, z = 120, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {4400, 200}},		}, difficultyAtLeast = 2, },
						{ name = 'euf_marine', x = 5000, z = 1900, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {4200, 1900}},	}, difficultyAtLeast = 3, },
						{ name = 'euf_marine', x = 2426, z = 959, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {0, 1000}},		}, },
						{ name = 'euf_marine', x = 2432, z = 1203, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {0, 1000}},		}, },
						{ name = 'euf_marine', x = 2433, z = 883, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {0, 1000}},		}, },
						{ name = 'euf_marine', x = 2445, z = 1125, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {0, 1000}},		}, },
						{ name = 'euf_marine', x = 5000, z = 800, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {0, 1000}},		}, },
						{ name = 'euf_marine', x = 5000, z = 820, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {0, 1000}},		}, },
						{ name = 'euf_marine', x = 5000, z = 840, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {0, 1000}},		}, },						
						{ name = 'euf_marine', x = 4700, z = 1400, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {4600, 600}},	}, },
						{ name = 'euf_marine', x = 4700, z = 1420, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {4700, 600}},	}, },
						{ name = 'euf_marine', x = 4700, z = 1440, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {4800, 600}},	}, difficultyAtLeast = 2, },
						{ name = 'euf_marine', x = 4750, z = 1400, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.PATROL, pos = {4600, 600}},	}, difficultyAtLeast = 3, },
					...
					midgameUnits = {
						{ name = 'euf_marine', x = 5000, z = 900, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						{ name = 'euf_marine', x = 5000, z = 940, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						{ name = 'euf_marine', x = 5000, z = 960, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						{ name = 'euf_marine', x = 5000, z = 1000, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						{ name = 'euf_marine', x = 5000, z = 1040, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						{ name = 'euf_marine', x = 5000, z = 1060, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 60*30, orbitalDrop = false,  },
						
						{ name = 'euf_marine',  x = 5000, z = 900, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 3*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine',  x = 5000, z = 940, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 3*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine',  x = 5000, z = 960, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 3*60*30, orbitalDrop = false,  },
						...
						{ name = 'euf_bazooka', x = 5000, z = 1040, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 3*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka', x = 5000, z = 1060, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 3*60*30, orbitalDrop = false,  },

						{ name = 'euf_marine',  x = 5000, z = 900, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 5*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine',  x = 5000, z = 940, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 5*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine',  x = 5000, z = 960, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 5*60*30, orbitalDrop = false,  },
						...
						{ name = 'euf_bazooka', x = 5000, z = 1040, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 5*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka', x = 5000, z = 1060, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 5*60*30, orbitalDrop = false,  },

						{ name = 'euf_marine',  x = 5000, z = 880, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine',  x = 5000, z = 890, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },						
						{ name = 'euf_marine',  x = 5000, z = 900, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine',  x = 5000, z = 940, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },
						...
						{ name = 'euf_bazooka', x = 5000, z = 1040, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka', x = 5000, z = 1060, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 7*60*30, orbitalDrop = false,  },

						{ name = 'euf_marine',  x = 5000, z = 880, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine',  x = 5000, z = 890, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },						
						{ name = 'euf_marine',  x = 5000, z = 900, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },
						{ name = 'euf_marine',  x = 5000, z = 940, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },
						...
						{ name = 'euf_bazooka', x = 5000, z = 1040, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },
						{ name = 'euf_bazooka', x = 5000, z = 1060, facing = 0, commands = { {cmdID = planetUtilities.COMMAND.FIGHT, pos = {0, 1000}},	}, spawnRadius = 0, delay = 9*60*30, orbitalDrop = false,  },						
					},
				},
			},
